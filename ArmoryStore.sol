...
contract ArmoryStore is Ownable {
    ...
    function findItemIdByName(string memory itemName) internal view returns (uint256) {
        ...
        return 0; // Return 0 if item name is not found
    }
}
